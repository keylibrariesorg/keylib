const styles = {
    ...
    bookAuthor: 'text-[20px] font-[400] font-Roboto text-[#333]',
    bookPublisher: 'text-[17px] font-[350] font-roboto text-[#333]',
    isbnNumber:"font-bold text-[18px] text-[#333] font-Roboto",
